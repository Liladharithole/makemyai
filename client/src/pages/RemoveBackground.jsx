      ...
      >
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] text-white px-6 py-3 rounded-xl hover:opacity-90 active:scale-[0.98] transition-all duration-200 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isProcessing ? (
              <>
              ...
              <>
                ...
                {imagePreview ? "Remove Background" : "Upload an Image First"}
              </>
            )}
          </button>
        </div>
        ...
        <div className="w-full p-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center min-h-[500px]">
          {isProcessing ? (
            ...
            <div className="text-center">
              <EraserIcon className="w-16 h-16 text-gray-300 mx-auto mb-4" />
