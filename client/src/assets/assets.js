// import logo from "./logoipsum-379.svg";
...
export const AiToolsData = [
  {
    title: "AI Prompt Generator (Reverse Engineering)",
    description:
      "Generate prompts that can understand by AI and generate by AI.",
    Icon: Sparkles,
    bg: { from: "#358", to: "#0BB0D7" },
...
export const dummyTestimonialData = [
  {
    ...
    name: "Rahul Sharma",
    title: "Digital Marketing Head, TechMahindra",
    content:
      "ContentAI has been a game-changer for our content strategy in the Indian market. The AI understands regional nuances and helps us create content that resonates with our diverse audience across India.",
    rating: 5,
  },
  {
    image: assets.profile_img_1,
    name: "Priya Patel",
    title: "Content Lead, Swiggy",
    content:
      "As a content creator in India's fast-paced startup ecosystem, ContentAI has been invaluable. It helps us maintain quality while scaling our content production across multiple regional languages.",
    rating: 5,
  },
  {
    image: assets.profile_img_1,
    name: "Arjun Mehta",
    title: "Founder & CEO, EduTech Innovations",
    content:
      "ContentAI has transformed how we create educational content in multiple Indian languages. The AI understands our cultural context and helps us produce relevant, engaging material for students across India.",
    rating: 4,
  },
  {
    image: assets.profile_img_1,
    name: "Ananya Gupta",
    title: "Social Media Manager, Myntra",
    content:
      "Managing social media for an Indian e-commerce giant is challenging, but ContentAI makes it easier. The AI helps us create culturally relevant content that drives engagement across all our regional pages.",
    rating: 5,
  },
  {
    image: assets.profile_img_1,
    ...
    content:
      "The multilingual support in ContentAI is exceptional. We can now create financial content in multiple Indian languages while maintaining accuracy and compliance with local regulations.",
    rating: 4,
  },
];
